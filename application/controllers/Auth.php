...
class Auth extends CI_Controller
{
	...
	public function login()
	{
		...
		$this->form_validation->set_rules('passwordlog', str_replace(':', '', $this->lang->line('login_password_label')), 'required');
		...
		if ($this->form_validation->run() === TRUE) {
			...
			$this->data['identity'] = [
				...
				'id' => 'identity',
				'type' => 'text',
				'value' => $this->form_validation->set_value('identitylog'),
			];
			...
			$this->_render_page('home' . DIRECTORY_SEPARATOR . 'login', $this->data);
		}
	}
	...
	public function create_user()
	{
		...
		if ($this->form_validation->run() === TRUE && $this->ion_auth->register($identity, $password, $email, $additional_data)) {
			...
			//$this->session->set_flashdata('message', $this->data['message']);
			//redirect('auth/login', 'refresh');
			$this->_render_page('login/' . DIRECTORY_SEPARATOR . 'index', $this->data);
		}
	}
	/**
